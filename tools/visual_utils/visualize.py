...
def draw_scene(points, gt_boxes=None, ref_boxes=None, ref_scores=None, ref_labels=None, confidence=0.0):
...
if __name__ == '__main__':
    ...
    import_dir = Path(os.getcwd()).parent.parent / 'output' / 'demo'

    with open(f'{import_dir}/data_dict.pkl', 'rb') as f:
        points = pickle.load(f)

    with open(f'{import_dir}/pred_dicts.pkl', 'rb') as f:
        pred_dicts = pickle.load(f)

    draw_scene(points=data_dict['points'][:, 1:], ref_boxes=pred_dicts[0]['pred_boxes'],

...
class PointGather(nn.Module):
    ...
    def transform_points_to_voxels(self, data_dict=None, config=None):
        ...
        self.point_cloud_range = torch.tensor(self.point_cloud_range,device=device)
        try:
        ...
        grid_size = (self.point_cloud_range[3:6] - self.point_cloud_range[0:3]) / torch.tensor(config.VOXEL_SIZE,device=device)

...
class MPPNetMemoryBank(RoIHeadTemplate):
    def __init__(self, input_channels, model_cfg, voxel_size, point_cloud_range, num_class=1,**kwargs):
        ...
        # if self.model_cfg.ROI_GRID_POOL.ONE_BALL:
    ...
    def generate_trajectory(self,cur_batch_boxes,proposals_list,roi_scores_list,batch_dict):
        ...
        batch_dict['effi_length'] = valid_length
    
        return trajectory_rois,trajectory_roi_scores,valid_length
    ...
    def forward(self, batch_dict):
        ...
        if batch_dict['sample_idx'][0] >=1:
            ...
            valid_length = valid_length[0,1:1+valid_length].bool() #rm dim of bs
            for i in range(valid_length):
                src_before[:,i][valid_length[i]] = feature_bank[i,matching_table[1+i][valid_length[i]]]
